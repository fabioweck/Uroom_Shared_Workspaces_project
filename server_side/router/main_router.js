...
router.post("/delistWorkspace", async (req, res) => {
  ...
  userService
    .delistWorkspace(user_id, workspace_id)
    .then((workpaceDelist) => {
...
router.post("/delistProperty", async (req, res) => {
  ...
  userService
    .delistProperty(user_id, property_id)
    .then((propertydelist) => {
